...
import '/components/payment_option_widget.dart';
              ...
              Expanded(
                child: TabBarView(
                  ...
                  children: [
                    StreamBuilder<List<OrdersRecord>>(
                      stream: queryOrdersRecord(
                        ...
                        queryBuilder: (ordersRecord) => ordersRecord
                            ...
                            .whereIn('order_status', ['completed', 'pending'])
                            .where(
                              'payment_status',
                              isEqualTo: 'unpaid',
                            )
                                                                          ...
                                                                          Container(
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              children: [
                                                                                Text(
                                                                                  formatNumber(
                                                                                    packagesDataItem.quantity * packagesDataItem.sellingPrice,
                    ...
                    PagedListView<DocumentSnapshot<Object?>?, OrdersRecord>(
                      pagingController: _model.setListViewController2(
                          OrdersRecord.collection(FFAppState().branchIdRef)
                              .where(
                                'order_status',
                                isEqualTo: 'completed',
                              )
