              ...
              child: Column(
                ...
                children: [
                  InkWell(
                    ...
                    onTap: () async {
                      _model.gpayReturn = await actions.paymentAction(
                        widget.orderDocument!.total,
                        widget.orderDocument!.userId,
                        widget.orderDocument!.orderId,
                        widget.orderDocument!.customerName,
                        'gpay',
                      );
                      if (_model.gpayReturn == 'SUCCESS') {
                  ...
                  Padding(
                    ...
                    child: InkWell(
                      ...
                      highlightColor: Colors.transparent,
                      onTap: () async {
                        _model.phonePeReturn = await actions.paymentAction(
                          widget.orderDocument!.total,
                          widget.orderDocument!.userId,
                          widget.orderDocument!.orderId,
                          widget.orderDocument!.customerName,
                  ...
                  Padding(
                    ...
                    child: InkWell(
                      ...
                      highlightColor: Colors.transparent,
                      onTap: () async {
                        _model.paytmReturn = await actions.paymentAction(
                          widget.orderDocument!.total,
                          widget.orderDocument!.userId,
                          widget.orderDocument!.orderId,
                          widget.orderDocument!.customerName,
