...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, state) =>
          appStateNotifier.loggedIn ? NavBarPage() : PhoneNumberLoginWidget(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
          ...
          routes: [
            ...
            FFRoute(
              ...
              path: 'listOfProducts',
              asyncParams: {
                'listAllSubCategory': getDocList(
                    ['root', 'categories'], CategoriesRecord.fromSnapshot),
              },
              builder: (context, params) => ListOfProductsWidget(
                ...
                listAllSubCategory: params.getParam<CategoriesRecord>(
                    'listAllSubCategory', ParamType.Document, true),
              ),
            ),
            FFRoute(
            ...
            FFRoute(
              ...
              builder: (context, params) => ServiceLocationWidget(),
            ),
            FFRoute(
              name: 'ordersPage',
              path: 'ordersPage',
        ...
        pageBuilder: (context, state) {
          ...
          final child = appStateNotifier.loading
              ? Container(
                  ...
                  child: Image.asset(
                    'assets/images/MySanji_customer_Splashscreen.png',
                    fit: BoxFit.cover,
                  ),
                )
              : page;
